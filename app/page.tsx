        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center text-center">
            <h1 className="text-5xl font-bold mb-6">
              Welcome to Nexus International Alliance Pvt Ltd
            </h1>
            <p className="text-xl mb-8 max-w-2xl">
              Transforming ideas into innovative solutions. We help businesses
              grow through cutting-edge technology and strategic consulting.
            </p>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              ...
              <p className="text-gray-600 mb-4">
                ...
                delivering exceptional solutions for our clients. With years of
                experience in the industry, we understand what it takes to
                succeed in today&apos;s digital landscape.
              </p>
              <p className="text-gray-600 mb-6">
                Our mission is to help businesses thrive by leveraging
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Contact us today to discuss how we can help your business grow and
            succeed.
          </p>
