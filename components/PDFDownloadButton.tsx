...
export default function PDFDownloadButton({ disabled = false, formData }: PDFDownloadButtonProps) {
  ...
  const handleDownload = async () => {
    try {
      ...
      const idCardImg = document.querySelector('img[alt="ID Card Preview"]') as HTMLImageElement;
      let idCardBase64 = '';
